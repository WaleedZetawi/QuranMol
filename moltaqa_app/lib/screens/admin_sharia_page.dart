...
class AdminShariaPage extends StatelessWidget {
  ...
  const AdminShariaPage({super.key, required this.userName});

  @override
  Widget build(BuildContext context) {
    final Color primaryBrown = const Color(0xFF8E6C46);
    final Color exportButtonColor = const Color(0xFFB07B4F);
    return Scaffold(
      backgroundColor: const Color(0xFFF4F6F8), // نفس خلفية الطب
      appBar: AppBar(
        title: const Text("مسؤول مجمع الشريعة"),
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  // زر تصدير الشهادات – منفصل تحت الشبكة زي صفحة الطب
                  SizedBox(
                  ...
                  // زر تسجيل الخروج – كبير وبارز في الأسفل
                  SizedBox(
                    width: maxWidth > 400 ? 300 : maxWidth * 0.8,
                    child: ElevatedButton.icon(
                  ...
                  Text(
                    "الشريعة هدى، والقرآن نور... اجعل القرآن منهج حياتك",
                    textAlign: TextAlign.center,
                    style: TextStyle(
      ...
      },
      {
        ...
        "action": () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => PendingScoresPage(college: "Sharia"),
            ),
          );
        },
      },
      ...
      },
      {
        ...
        "action": () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => const CollegeExamRequestsPage(college: "Sharia"),
            ),
          );
        },
      },
