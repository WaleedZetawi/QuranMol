...
class AdminEngPage extends StatelessWidget {
  ...
  const AdminEngPage({super.key, required this.userName});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("مسؤول مجمع الهندسة"),
                ...
                children: [
                  ...
                  Expanded(
                    child: GridView.count(
                      ...
                      children: _buildMainButtonsWithoutExport(context),
                    ),
                  ),
                  ...
                  // زر تسجيل الخروج - في الوسط، كبير، بارز
                  SizedBox(
                    width: maxWidth > 400 ? 300 : maxWidth * 0.8,
                    child: ElevatedButton.icon(
  ...
  List<Widget> _buildMainButtonsWithoutExport(BuildContext context) {
    final buttonsData = [
      {
        "title": "📋 قائمة الطلاب",
        "action": () {
      ...
      },
      {
        ...
        "action": () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => PendingScoresPage(college: "Engineering"),
            ),
          );
        },
      },
      ...
      },
      {
        ...
        "action": () {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (_) =>
                  const CollegeExamRequestsPage(college: "Engineering"),
            ),
          );
        },
      },
